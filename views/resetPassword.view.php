...
if (empty($_SESSION['token']) && empty($_SESSION['errors'])) {
...
$epoch = time();
$current_time = date("Y-m-d H:i:s", $epoch);
        ...
        <div class="container">
            <div class="row">
                <div class=" col-md-offset-4 col-md-4">
                    ...
                    <form name="reset_password" method="post" action="/../app/resetPassword.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password_check"
                                   placeholder="Confirm New Password" name="password_check">
                        ...
                        <div class="form-group form-inline">
                            <button type="submit" class="btn btn-default"
                                    name="reset_button" id="submit">Submit
                            </button>
                        </div>
                    </form>
                </div>
